...
QT_MOC_LITERAL(2, 33, 0) // ""
    ...
    "JanelaLogin\0on_btn_login_clicked\0"
};
...
void JanelaLogin::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        JanelaLogin *_t = static_cast<JanelaLogin *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
...
const QMetaObject JanelaLogin::staticMetaObject = {
    { &QMainWindow::staticMetaObject, qt_meta_stringdata_JanelaLogin.data,
      qt_meta_data_JanelaLogin,  qt_static_metacall, nullptr, nullptr}
};
